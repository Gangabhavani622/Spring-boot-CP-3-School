...
public class StudentH2Service implements StudentRepository {
    ...
    @Override
    public String addStudentsList(ArrayList<Student> students) {
        ArrayList<Student> savedStudents = new ArrayList<>();
        for (Student eachStudent : students) {
            Student newStudent = addStudent(eachStudent);
            savedStudents.add(newStudent);
        }
        String sucessMsg = String.format("Successfully added %d students", savedStudents.size());
